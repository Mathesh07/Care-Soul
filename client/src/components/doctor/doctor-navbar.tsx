...
export default function DoctorNavbar({ activeTab, setActiveTab }: DoctorNavbarProps) {
  ...
  return (
    <>
      ...
      <nav className="sticky top-0 z-50 border-b border-white/[0.08] backdrop-blur-xl bg-card/50 shadow-navy-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Desktop Menu - Empty for now, tab navigation is below */}
      ...
      {/* Doctor-Specific Tab Navigation */}
      <div className="bg-surface border-b border-border overflow-x-auto sticky top-16 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
